...
void imprimirCor(int l, const RGB &cor, char nomeCor)
{
    if(l==1) Serial.print("[Direito] R:");
...
void loop()
{
    ...
    imprimirCor(1, sensorEsquerdo, corNomeEsq);
    imprimirCor(0, sensorDireito, corNomeDir);
